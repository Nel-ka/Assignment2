...
//Defining the function for calculating the var of random numbers
double var(char *str)
{
int i=0,c;
FILE *fp;
double x, temp=0.0,temp2=0.0,var=0.0;
...
//End function for calculating the var of random numbers
