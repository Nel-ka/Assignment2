...
%\end{lstlisting}
%\begin{itemize}
%\item Mean of uniform distribution = 0.500007.\item Variance of uniform distribution = 0.083301.
%\end{itemize}
%
...
%& =E[U^2]-E[U]^2
%\\
%& Given, E[U]^k = \int_{-\infty}^{\infty}x^k dF_{U}(x) 
%\\
%&For~E[U],~k=1~and~limits~are~from~0-1.
%\\
%&E[U] = \int_{0}^{1}x dF_{U}(x) 
%\\
%&~~~~~~= \int_{0}^{1}x dF_{U}(x) 
%\end{align*}
%$dF_{U}(x)$ for uniformly distributed function is $\frac{1}{b-a}$ where b=1 and a=0.
%\begin{align*}
%\\
%&= \frac{1}{1-0}\int_{0}^{1}x.dx 
%\\
%&= \frac{1}{1-0}*[\frac{x^2}{2}]_{0}^{1}
%\\
%&= \frac{1}{2}=0.5.
%\\
%&~E[U^2] =\frac{1}{1-0}\int_{0}^{1}x^2.dx 
%\\
%&= \frac{1}{1-0}*[\frac{x^3}{3}]_{0}^{1}
%\\
%&= \frac{1}{3}=0.3333.
%\\
%&=E[U^2]-E[U]^2
